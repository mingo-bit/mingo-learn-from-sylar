#ifndef MINGO_TCP_SERVER_H
#define MINGO_TCP_SERVER_H
...
public:
     ...
     */
    TcpServer(mingo::IOManager* worker = mingo::IOManager::GetThis()
              ,mingo::IOManager* io_woker = mingo::IOManager::GetThis()
     ...
     * @return 返回是否绑定成功
     */
    virtual bool bind(mingo::Address::ptr addr/*, bool ssl = false*/);
