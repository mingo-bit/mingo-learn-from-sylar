...
int32_t FunctionServlet::handle(mingo::http::HttpRequest::ptr request
               , mingo::http::HttpResponse::ptr response
...
ServletDispatch::ServletDispatch()
    ...
    m_default.reset(new NotFoundServlet("mingo/1.0"));
}

int32_t ServletDispatch::handle(mingo::http::HttpRequest::ptr request
               , mingo::http::HttpResponse::ptr response
               , mingo::http::HttpSession::ptr session) {
...
int32_t NotFoundServlet::handle(mingo::http::HttpRequest::ptr request
                   , mingo::http::HttpResponse::ptr response
                   , mingo::http::HttpSession::ptr session) {
    response->setStatus(mingo::http::HttpStatus::NOT_FOUND);
    response->setHeader("Server", "mingo/1.0.0");
